...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const channels = await getUserWatchedChannels(user.id);
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields({
        name: 'Din personliga kalender-länk (.ics)',
        value: `\`${process.env.SERVER_URL || 'http://localhost:3000'}/api/calendar/${dbUser.calendar_token}.ics\``
      }).setColor(0x00FF00);
